...
%>
<body>
<header class="layui-bg-green"><h1>添加用户</h1></header>
<div class="login-body">
    ...
    <button id="btn_add" class="layui-btn layui-bg-green">提交</button>
    ...
    function addUserInfo() {
        ...
        if (checkInput(username, password)) {
            ...
            setTimeout(function () {
                $.ajax({
                    type: "POST",
                    url: "${ctx}/api/userInfo",   //请求URL地址
                    dataType: "json",           //服务器返回数据类型
                    data: {username: username, loginName: username, password: password}, //请求参数
