...
public class SqlBadWordUtil {
    ...
    private static File getKeywordFile() {
        ...
        try {
             ...
             */
            // 获取到classpath下的文件
            java.net.URL url = Class.forName(SqlBadWordUtil.class.getName()).getResource("resources/sqlKeywords.txt");
            // 获取到package下的文件
//            input = Class.forName(ClassLoaderDemo.class.getName()).getResourceAsStream("resources/dbconfig.properties");
     ...
     * @return 敏感词Set集合
     */
    public static Set<String> readKeyWordsFromFileByLine(String path) {
        ...
        try {
            ...
            reader = new BufferedReader(new InputStreamReader(new FileInputStream(file), StandardCharsets.UTF_8.displayName()));
